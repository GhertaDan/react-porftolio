...
import { faTrash, faSignOutAlt, faEdit, faMinusSquare, faSpinner, faPlusCircle } from '@fortawesome/free-solid-svg-icons';
...
library.add(faTrash, faSignOutAlt, faEdit, faMinusSquare, faSpinner, faPlusCircle)
